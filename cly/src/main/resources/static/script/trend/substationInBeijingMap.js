...
(function($){
    ...
    function queryData(){
        ...
        if(hotel){
            checkNum++
            $.ajax({
                url: context + '/inBeijingMap/findSubstationHotelTrack',
                data: obj,
                type: "post",
                success: function (map) {
        ...
        if(netBar){
            checkNum++
            $.ajax({
                url: context + '/inBeijingMap/findSubstationNetBarTrack',
                data: obj,
                type: "post",
                success: function (map) {
                    if(map.serchNum == serchNum) {
        ...
        if(check){
            checkNum++
            $.ajax({
                url: context + '/inBeijingMap/findSubstationCheckTrack',
                data: obj,
                type: "post",
                success: function (map) {
                    if(map.serchNum == serchNum) {
        ...
        if(changAnData){
            $.ajax({
                url: context + '/inBeijingMap/findSubstationChangAnDataTrack',
                data: obj,
                type: "post",
                success: function (map) {
                    if(map.serchNum == serchNum) {
