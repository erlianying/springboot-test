    ...
    function events(){
        ...
        $(document).on("click",".btnMessage",function() {
            ...
            $.util.topWindow().$.layerAlert.dialog({
                content : context + '/show/page/web/clue/message',
                pageLoading : true,
                title : title,
                width : "500px",
                height : "400px",
                ...
                callBacks:{
                    btn1:function(index, layero){
                        var cm = $.util.topWindow().frames["layui-layer-iframe"+index].$.messageLayer ;  //获取弹窗界面的操作对象
                        cm.saveMessage();
                    },
            ...
            },
            {
                ...
                "render" : function(data, type, full, meta) {
                    var str = '<p class="text-center">'+
                        '<a href="###" class="btn btn-default btn-xs btnMessage" clueId="' + full.id + '">督办</a>'+
                        '</p>';
                    return str;
                }
            }
