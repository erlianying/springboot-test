(function($){
    ...
    $(document).ready(function() {
        ...
        if(!$.util.isBlank(startTime)){     //图跳转过来的查询 20180131LGQ
            initData();
            initClueTable();
    ...
    function initClueTable(){
        ...
        if(queryStatus == "fullQuery"){
            functionName = "/clue/findCluePageByFullForFeedback";
        }else if(queryStatus == "clueQuery"){
            functionName = "/clue/findCluePageByClueForFeedback";
        }
        ...
        tb.paramsReq = function(d, pagerReq){
            ...
            if(queryStatus == "fullQuery"){
                ...
                obj.feedbackTimeOneLong = $.laydate.getTime("#feedbackTime", "start");
                obj.feedbackTimeTwoLong = $.date.endRangeByTime($.laydate.getTime("#feedbackTime", "end"),"yyyy-MM-dd");
                obj.feedbackContent = $("#feedbackContent").val();
    ...
    function exportExcel(btnType){
        ...
        if(queryStatus == "fullQuery"){
            url = context + "/clue/exportCluePageByFullForFeedback";
            var obj = {};
            ...
            url =context +  "/clue/exportCluePageByClueForFeedback";
            var obj={};
            obj.content = $("#clueContent").val();
            obj.doneTimeOneLong = $.laydate.getTime("#doneTime", "start");
            obj.doneTimeTwoLong = $.date.endRangeByTime($.laydate.getTime("#doneTime", "end"),"yyyy-MM-dd HH:mm");
