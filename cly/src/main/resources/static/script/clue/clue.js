...
(function($){
    ...
    function initData(){
        $.ajax({
            url:context +'/clue/findClueInfoByStartTime',
            type:'post',
            data:{
        ...
        /*
        $.ajax({
            url:context +'/clue/findClueAlert',
            type:'post',
            data:{
                startTimeOne : $.laydate.getTime("#startTime", "start"),
                startTimeTwo : $.date.endRangeByTime($.laydate.getTime("#startTime", "end"),"yyyy-MM-dd")
    ...
    function showWindow(tranData){
        ...
        //get
        var str = context + "/show/page/web/clue/clueQuery?";
        ...
        $.ajax({
            ...
            success:function(successData){
                if(successData){
                    if(successData.organizationId == "007") {
                        str = context + "/show/page/web/clue/clueWarnDeal?";
                    }
                }
