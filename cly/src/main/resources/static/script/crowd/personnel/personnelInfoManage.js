(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", "#selectImportLogBtn", function (e) {//人员导入日志
            selectImportLog();
        });
        ...
        $(document).on("click", "#editPersonal", function (e) {
            editPersonalBtnClick();
        });
        $(document).on("click", "#personBatchImportBtn", function (e) {
            personBatchImportExcel();
        });
        $(document).on("click", "#personBatchExportBtn", function (e) {
            personBatchExport();
        });
        $(document).on("click", "#ExprotToWordBtn", function (e) {
            ExprotToWordBtn();//人员档案导出成Word；
        });

        $(document).on("select2:unselect", "#crowdType", function (e) {
            var arr = {"idList": $.select2.val("#crowdType")};
            var obj = new Object();
        ...
        $(document).on("select2:unselect", "#crowdName", function (e) {
            var arr = {"idList": $.select2.val("#crowdName")};
            var obj = new Object();
            $.util.objToStrutsFormData(arr, "idList", obj);
            if (arr.idList != null) {
                $.ajax({
        ...
        $(document).on("select2:unselect", "#personnelSubclassOne", function (e) {
            var arr = {"idList": $.select2.val("#personnelSubclassOne")};
            var obj = new Object();
            $.util.objToStrutsFormData(arr, "idList", obj);
            if (arr.idList != null) {
                $.ajax({
        ...
        $(document).on("click", ".personId", function (e) {
            var form = $.util.getHiddenForm(context + "/show/page/web/personnel/personnelDetail", {personId: $(this).attr("valId")});
            form.submit();
        });
    });
